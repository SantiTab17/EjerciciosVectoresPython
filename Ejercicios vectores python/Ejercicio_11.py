#11. Cargar dos vectores cada uno con 5 datos enteros y deteminar si los datos almacenados en ambos vectores son exactamente los mismos tanto en contenido como en posicion.
def cargar_vector():
    vector = []
    for i in range(5):
